...
if __name__ == '__main__':
    ...
    # Bakery Pagariposid: 0 baker(s) => Baker Ago was not added because of low
    # experience level (Sorry Ago)
    print(bakery1)
    # None => No such recipe nor baker in bakery
    ...
    # [Baker: Polly(14), Baker: Emma(12), Baker: Sam(11)] =>
    print(bakery1.get_bakers())
    # Polly was chosen to be the baker because 'cake' complexity and Polly
    # experience lever were the closes
    ...
    print(bakery1.get_pastries())
    # [cake] ("NB! cake is instance of class Pastry, not a string)
    ...
    # {'muffin': 7, 'cupcake': 10, 'biscuits': 13}
    print(bakery2.get_recipes())

    # [Baker: Kate(18), Baker: Megane(17), Baker: John(11)]
    print(bakery2.get_bakers())
    bakery2.make_order("biscuits")
    # [Baker: Megane(25), Baker: Kate(18), Baker: John(11)]
    print(bakery2.get_bakers())
# Magane was chosen to be the baker as the most closest experience (which is
# also greater than complexity) was 17.
